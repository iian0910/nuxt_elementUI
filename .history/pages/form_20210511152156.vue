      ...
      <el-row :gutter="40">
        <ValidationObserver v-slot="{ handleSubmit }" ref="form" tag="div">
          <el-col :xs="24" :md="12" class="col-mb">
            <ValidationProvider mode="passive" rules="required" v-slot="{ errors, classes }">
              <div :class="classes">
                <label for="name">欄位1</label>
...
.is-valid {
  border: rgb(40, 121, 40) 1px solid;
}
.is-invalid {
  border: #e33a3a 1px solid;
  background: rgba(#faa8a8, 0.5);
  ::after {
    content: 'X';
    display: block;
  }
