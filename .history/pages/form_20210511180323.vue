    ...
    <el-main>
      <el-row :gutter="40">
        <ValidationObserver v-slot="{ handleSubmit }" ref="form" tag="div">
          ...
          <el-col :xs="24" :md="12">
            <ValidationProvider mode="lazy" rules="image" v-slot="{ errors, validate, classes }" tag="div">
              <label for="uploadFile">上傳檔案(rules="image")</label>
              <input id="uploadFile" type="file" name="avatar" @change="validate">
              <div :class="classes">
