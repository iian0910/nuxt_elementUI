  ...
  <div>
    <div class="info">
      ...
      <div class="cus-input">
        ...
        <el-select v-model="city" class="city-input" placeholder="縣市" @change="changeCity">
          <el-option value="">
            請選擇
          </el-option>
        ...
        <el-select v-model="area" class="area-input" placeholder="區域" @change="getZipCode($event)">
          <el-option value="">
            請選擇
          </el-option>
