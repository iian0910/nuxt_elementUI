<template>
  <div>
    <div class="info">
      ...
      <label class="cus-label" for="zip">區碼</label>
      <el-input id="zip" v-model="zip" class="cus-input" placeholder="區碼" disabled />
      <label class="cus-label" for="city">縣市</label>
      <el-select id="city" v-model="city" class="cus-input" placeholder="縣市">
        <el-option value="">
          請選擇
        </el-option>
      </el-select>
...
.info {
  ...
  width: 500px;
  height: 500px;
  border: 1px solid rgb(10, 235, 167);
}
.cus-label {
  margin-bottom: 5px;
  font-size: 16px;
